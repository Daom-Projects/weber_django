...
# El segundo argumento es un valor por defecto si no la encuentra
SECRET_KEY = env('SECRET_KEY', default='django-insecure-)5@ke5c6$8ff025u)9pnfotqxn!0_2c^3#u4z*s-_wkc*$ww!d')


# Lee el valor de DEBUG desde el archivo .env
# El cast a bool es importante.
...
DATABASES = {
    'default': {
        ...
        'HOST': env('DB_HOST'),
        # Usamos env.int() para asegurarnos de que el puerto sea un número entero
